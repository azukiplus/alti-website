            ...
            <Row style={{ marginRight: 0, marginLeft: 0 }} className='ms-5'>
                <Col sm={7}>
                    <section className='ms-3 mt-5'>
                        ...
                        <p>
                            Note: You must be an administrator of the discord
                            server you want to add Alti to.
                        </p>
                        <p>
                            Add Alti to the respective server you want through
                            this{" "}
                            <a
                    ...
                    <section className='ms-3 mt-5'>
                        ...
                        <p>Choose if you would like to enable ALti</p>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit, sed do eiusmod tempor incididunt ut labore et
                            dolore magna aliqua. Varius vel pharetra vel turpis
